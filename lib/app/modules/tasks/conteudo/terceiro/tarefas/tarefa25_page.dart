        ...
        child: Column(children: [
          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(text: 'sentado (a)', style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                TextSpan(text: '. Repete algumas vezes o movimento de sentar e levantar.'),
              ],
            ),
          ),
          SizedBox(height: 10.0,),
          // Radin(UID,'DEV25TASK2'),
          ...
          RichText(
            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                ...
                TextSpan(text: 'posição em pé', style: TextStyle(fontWeight: FontWeight.bold)),
                TextSpan(text: ', você pode ajudar, mas lembre-se, é importante reduzir as ajudas para concluir os movimentos, deixando independente.'),
              ],
            ),
